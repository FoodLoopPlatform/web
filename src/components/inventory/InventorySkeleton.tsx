  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-md animate-pulse">
      {[1, 2, 3, 4].map((i) => (
        <div
          key={i}
          className="bg-surface-container-high/40 rounded-xl h-[320px] border border-outline-variant/30 flex flex-col p-4 justify-between"
        >
          <div className="bg-surface-container-highest rounded-lg h-40 w-full" />
